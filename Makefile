...
build: contactBook.o createContact.o getAction.o initializeStruct.o printContactList.o printMenu.o deleteContact.o findOneContact.o updateContact.o
	$(CC) contactBook.o createContact.o getAction.o initializeStruct.o printContactList.o printMenu.o deleteContact.o findOneContact.o updateContact.o -o build
